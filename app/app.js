...
// );
// userClient.use((req, res) =>
//   res.sendFile(path.join(__dirname, "client", "user", "build", "index.html"))
// );
// adminClient.use((req, res) => {
//   authMiddle.isAdmin(req, res, (err, success) => {
//     console.log("HERE2!!!!!!!");
//     if (err) {
...
//       );
//     } else {
//       console.log("You have not permissions");
//     }
//   });
// });
...
userClient.use(express.static(path.join(__dirname, 'client', 'user', 'build')));
userClient.get('/', (req, res, next) => res.sendFile(__dirname, 'client', 'user', 'build', 'index.html'));
adminClient.use(express.static(path.join(__dirname, 'admin', 'user', 'build')));
adminClient.get('/', (req, res, next) => res.sendFile(__dirname, 'client', 'admin', 'build', 'index.html'));
