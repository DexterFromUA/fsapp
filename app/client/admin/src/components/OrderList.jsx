...
const OrderList = props => {
        ...
        <tbody>
          {props.orders.map(item => (
            <tr>
              <td>{item.id}</td>
              <td>
                {item.usersModel.name}, {item.usersModel.lastName}
              </td>
              <td>
                <Container>
              ...
              <td>
                <Container>
                  {item.ordersProducts.map(pr => (
                    <Row>
                      ${pr.productsmodel.price} x {pr.amount} = $
                      {pr.productsmodel.price * pr.amount}
                    </Row>
                  ))}
                </Container>
              </td>
              <td>
                <Form.Group>
                  ...
                  >
                    ...
                    <option selected={item.status === "In Processing"}>
                      In Processing
                    </option>
  ...
  return (
    <ListGroup>
      <ListGroupItem>Haven't orders</ListGroupItem>
    </ListGroup>
  );
};
